    ...
    return (
        <div className=' h-full w-full flex  flex-wrap justify-between items-center'>
            <div className='left ml-32 mb-20'>
                ...
                <h1 className='text-6xl mb-5 font-bold font-poppins text-violet-950'>I'm Anil <span className=' text-orange-600'>Reddy</span></h1>
                <h1 className='text-4xl font-semibold font-poppins text-slate-100'>Web Developer</h1>
                <button className='py-2.5 px-8 my-6 shadow-md shadow-orange-500 font-poppins font-semibold text-white bg-orange-600 rounded-full'>About Me</button>
