...
import bitmojiimg from '../assets/bitmojihi-removebg-preview.png'
import '../common.css'
          ...
          >
            About Me
                ...
                <ul className='flex gap-2.5'>
                    <li className='twitter p-2 bg-gray-900 rounded-full'>
                        <a href="https://www.twitter.com/i_am_anilreddy" target="_blank">
                        <svg
                            viewBox="0 0 512 512"
                            fill="currentColor"
                    ...
                    <li className='instagram p-2 bg-gray-900 rounded-full'>
                        <a href="http://www.instagram.com/i_am_anilreddy" target="_blank">
                        <svg
                    ...
                    <li className='linkedin p-2 bg-gray-900 rounded-full'>
                        <a href="https://www.linkedin.com/in/anil-reddy-513866227" target="_blank">
                        <svg
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            className='w-7 h-7 text-blue-500'
                    ...
                    <li className='github p-2 bg-gray-900 rounded-full'>
                        <a href="https://www.github.com/AnilReddyDev"  target="_blank">
                        <svg
                            viewBox="0 0 496 512"
                            fill="currentColor"
                            className='w-7 h-7 text-blue-500'
