    ...
    <div className='w-full font-poppins pt-navb h-screen bg-slate-200'>
      ...
      <div className='w-full mt-20 flex-wrap py-12 gap-12 justify-center items-center flex'>
        ...
        <div className='right font-poppins w-width40rem h-96 '>
          <h1 className='text-2xl font-bold '>I'm Anil Reddy</h1>
          <h1 className='text-lg font-semibold text-violet-900'>Full stack developer</h1>
          <p className='font-medium my-3'>I'm a passionate Full-Stack developer hailing
          ...
          <p className=' font-medium mb-4' ><span className='text-blue-600'>Email :</span> konyalaanilreddy00@gamil.com</p>
          <p className=' font-medium'><span className='text-blue-600'>Place :</span> Hyderabad, India - 500100</p>
          <button className='w-32 inline-flex hover:gap-1 transition-all ease-in duration-75 justify-center items-center h-12 text-white rounded-md mt-5 shadow-md text-md shadow-blue-600 bg-blue-800'>Resume <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className=" w-5 h-5">
