...
export default function About() {
  return (
    <div className='w-full font-poppins pt-navb h-screen bg-slate-200'>
      ...
      <div className='w-full mt-1 sm:mt-20 flex-wrap py-5 sm:py-12 gap-2 sm:gap-5 sm:gap-12 justify-center items-center flex'>
        ...
        <div className='right font-poppins w-width40rem h-96 px-2 sm:px-0'>
          ...
          <p className='font-medium my-1 sm:my-3'>I'm a passionate Full-Stack developer hailing
