...
export default function Skill() {
  return (
    <div className='w-full font-poppins pt-navb h-screen bg-violet-700'>
      <div className='w-full my-10 text-white flex justify-center items-center gap-1'>
      ...
      <div className='w-full h-4/5   items-center flex justify-center'>
        <div className='w-4/5 h-full rounded-lg bg-violet-950  opacity-80'>
            <SkillCards/>
        </div>
      </div>
    </div>
