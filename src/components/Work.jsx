...
export default function Work() {
  ...
  return (
    <div className='w-full font-poppins pt-navb pb-7 sm:pb-0 sm:h-screen  bg-violet-700'>
      <div className='w-full mt-4 sm:mt-7 mb-6 sm:mb-10 flex justify-center items-center gap-1'>
        ...
        <h1 className='text-3xl sm:text-4xl font-bold text-white text-center'>My <span className='text-yellow-400'>Projects</span></h1>
      </div>
      <div className='w-full h-auto gap-5 sm:gap-7 flex flex-wrap justify-center items-center '>
